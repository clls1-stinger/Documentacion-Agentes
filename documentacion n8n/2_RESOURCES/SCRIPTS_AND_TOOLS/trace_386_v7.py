...
cursor = conn.cursor()
cursor.execute("SELECT data FROM execution_data WHERE executionId = 386")
...
print_node_output("Final Response")
print_node_output("Actor Prep")
print_node_output("Tool Router")
print_node_output("Drive Search")
